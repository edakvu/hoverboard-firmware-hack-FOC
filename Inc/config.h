...
// ############################### STARTUP DELAY ################################
#define STARTUP_DELAY_MS        100       // startup delay [ms] before power latch is activated. Prevents spurious power-on from brief supply glitches (e.g. UART back-powering).
// ######################## END OF TEMPERATURE ###############################
